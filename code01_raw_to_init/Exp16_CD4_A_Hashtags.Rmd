...
```{r parameters}
raw.matrix.path <- '../data/raw/GEX/exp16_CD4_A/raw_feature_bc_matrix/'
target.path <- 'Hashtags_exp16_CD4_A/'
min.GE <- 200
hash.prop.lim <- 0.1
sample.strains <- c('H1', 'H2', 'H3', 'H4', 'H5', 'H6', 'H7', 'H8', 'H9')
strain.markers <- c('H1', 'H2', 'H3', 'H4', 'H5', 'H6', 'H7', 'H8', 'H9')
split.auto <- TRUE
cutoff.values <- c()
```
